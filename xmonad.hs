...
--      , ((modMask .|. shiftMask, xK_q), spawn "xfce4-session-logout")
  ...
  , ((modMask .|. shiftMask, xK_Left), withFocused (keysMoveWindow (-30, 0)))
  , ((modMask .|. shiftMask, xK_Up), withFocused (keysMoveWindow (0, -30)))
  , ((modMask .|. shiftMask, xK_Right), withFocused (keysMoveWindow (30, 0)))
  , ((modMask .|. shiftMask, xK_Down), withFocused (keysMoveWindow (0, 30)))
  , ((modMask, xK_Left), withFocused (keysResizeWindow (-30, 0) (0, 0)))
  , ((modMask, xK_Up), withFocused (keysResizeWindow (0, -30) (0, 0)))
  , ((modMask, xK_Right), withFocused (keysResizeWindow (30, 0) (0, 0)))
  , ((modMask, xK_Down), withFocused (keysResizeWindow (0, 30) (0, 0)))
